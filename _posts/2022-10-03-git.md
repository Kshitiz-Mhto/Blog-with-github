...
*BUT*
```
With GIT, It treat the data as stream of Snapshots. When we save or commit our changes, Git took snapshot of the project of that instance of the time and returns a reference to that snapshot, To be more precisely it dont store the unchange/unmodified files again; instead GIT refer a link to the previously stored that file. 
```
<div align="center">
